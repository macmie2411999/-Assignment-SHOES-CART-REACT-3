                        ...
                        <div class="card_home">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-primary"><a href="../detail?idShoes=${shoes.id}">Buy now</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    for (let shoes of arrayShoes) {
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button class="button-buy-now"> <a href="../detail?idShoes=${shoes.id}">Buy now</a></button>
